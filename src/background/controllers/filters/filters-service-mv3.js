...
export class FiltersController {
  ...
  static async #onFilterEnable(message) {
     ...
     */
    await FiltersController.#enableFilter(filterId, true);
  ...
  static async #onGroupEnable(message) {
    ...
    if (group.touched) {
      await FiltersController.#enableGroup(groupId);
      return;
    }
    ...
    await FiltersController.#enableGroup(groupId, recommendedFiltersIds);
  ...
  static async #enableFilter(filterId, shouldEnableGroup = false) {
    await FiltersService.loadAndEnableFilters([filterId], false, shouldEnableGroup);
  }
}
